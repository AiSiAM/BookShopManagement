...
namespace BookShopManagement
{
    public partial class FormAdmin : Form
    {
        ...
        public FormAdmin(string nameInfo, string role, FormLogin fl) : this()
        {
        ...
        {
            moveSidePanel(btnManageBooks);
            this.Hide();
            FormManageBooks manageFrom = new FormManageBooks(this.UserName, this.UserRole, this.Fl);
            manageFrom.Show();
        ...
        private void btnUsers_Click(object sender, EventArgs e)
        {
            moveSidePanel(btnManageBooks);
            this.Hide();
            FormUsers userFrom = new FormUsers(this.UserName, this.UserRole, this.Fl);
            userFrom.Show();
        }
    }
}
